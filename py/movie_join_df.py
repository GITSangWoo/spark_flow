...
LOAD_DT=sys.argv[1]
spark = SparkSession.builder.appName("MovieJoin").getOrCreate()

df1 = spark.read.parquet(f"/home/centa/data/movie/repartition/load_dt={LOAD_DT}")
...
df_j.write.mode('append').partitionBy("load_dt", "multiMovieYn", "repNationCd").parquet("/home/centa/data/movie/hive/")
